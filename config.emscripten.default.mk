...
PLATFORM_LDFLAGS = -Wl --preload-file bin/data@data --emrun --bind -s DYNCALLS=1 -s MAX_WEBGL_VERSION=2 -s WEBGL2_BACKWARDS_COMPATIBILITY_EMULATION=1 -s USE_PTHREADS=1  -s ENVIRONMENT=web,worker,audioworklet --post-js $(OF_ADDONS_PATH)/ofxEmscripten/libs/html5audio/lib/emscripten/audioworklet_tone_post.js --post-js $(OF_ADDONS_PATH)/ofxEmscripten/libs/html5audio/lib/emscripten/library_pdMethods.js -s USE_FREETYPE=1 -s PROXY_TO_PTHREAD=0 -s OFFSCREENCANVAS_SUPPORT=1 -s OFFSCREEN_FRAMEBUFFER=1 -s PTHREAD_POOL_SIZE=0 --profiling-funcs -s ALLOW_MEMORY_GROWTH=1
